export default async function decorate(block) {
  ...
  try {
    ...
    const blockContent = blockData?.["jcr:content"]?.root?.section?.block;
    ...
    if (blockContent["layout-type"] === "dynamic-article-link") {
      const dynamicLink = blockContent["dynamic-article-link"];
